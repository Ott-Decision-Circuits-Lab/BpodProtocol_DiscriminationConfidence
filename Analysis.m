...
elseif TaskType == "time-investment" ||  TaskType == "temporal-reward-bias"
...
CatchndxTrial = idxTrial(CatchTrial == 1);
RewardedndxTrial = idxTrial(Rewarded == 1);
SkippedFeedbackndxTrial = idxTrial(SkippedFeedback == 1);
ChoiceLeftndxTrial = idxTrial(ChoiceLeft == 1);

YTickLabel = {strcat(num2str(nTrials), ' | 100%'),...
              ['NoTrialStart: ', num2str(length(NoTrialStartndxTrial)), ' | ', sprintf('%04.1f', 100*length(NoTrialStartndxTrial)/nTrials), '%'],...
              ['BrokeFixation: ', num2str(length(BrokeFixationndxTrial)), ' | ', sprintf('%04.1f', 100*length(BrokeFixationndxTrial)/nTrials), '%'],...
              ['EarlyWithdrawal: ', num2str(length(EarlyWithdrawalndxTrial)), ' | ', sprintf('%04.1f', 100*length(EarlyWithdrawalndxTrial)/nTrials), '%'],...
              ['IncorrectChoice: ', num2str(length(IncorrectChoicendxTrial)), ' | ', sprintf('%04.1f', 100*length(IncorrectChoicendxTrial)/nTrials), '%'],...
              ['Catch: ', num2str(length(CatchndxTrial)), ' | ', sprintf('%04.1f', 100*length(CatchndxTrial)/nTrials), '%'],...
              ['Rewarded: ', num2str(length(RewardedndxTrial)), ' | ', sprintf('%04.1f', 100*length(RewardedndxTrial)/nTrials), '%'],...
              ['SkippedFeedback: ', num2str(length(SkippedFeedbackndxTrial)), ' | ', sprintf('%04.1f', 100*length(SkippedFeedbackndxTrial)/nTrials), '%'],...
              ['ChoiceLeft: ', num2str(length(ChoiceLeftndxTrial)), ' | ', sprintf('%04.1f', 100*length(ChoiceLeftndxTrial)/nTrials), '%'],...
              'Count |       %'};
...
title(EventOverviewHandle, 'Event Proportion', 'FontSize', 12);
