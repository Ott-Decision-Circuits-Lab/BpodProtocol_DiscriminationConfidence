...
%         AxesHandles.HandlePsycOlf.XLim = 100*[-.05 1.05];
    ...
    case 'update'
        ...
        if TaskParameters.GUI.ShowVevaiometric
            ...
            WTerr = grpstats(BpodSystem.Data.Custom.InvestmentRatio(ndxError&ndxMinWT),BinIdx(ndxError&ndxMinWT),'mean')';
            WTcatch = grpstats(BpodSystem.Data.Custom.InvestmentRatio(ndxCorrectCatch&ndxMinWT),BinIdx(ndxCorrectCatch&ndxMinWT),'mean')';
            ...
            if TaskParameters.GUI.VevaiometricShowPoints
                BpodSystem.GUIHandles.OutcomePlot.VevaiometricPointsErr.YData = BpodSystem.Data.Custom.InvestmentRatio(ndxError&ndxMinWT);
                BpodSystem.GUIHandles.OutcomePlot.VevaiometricPointsErr.XData = DV(ndxError&ndxMinWT);
                BpodSystem.GUIHandles.OutcomePlot.VevaiometricPointsCatch.YData = BpodSystem.Data.Custom.InvestmentRatio(ndxCorrectCatch&ndxMinWT);
