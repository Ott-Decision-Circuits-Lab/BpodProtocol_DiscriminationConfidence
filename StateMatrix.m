...
if BpodSystem.Data.Custom.TrialData.AuditoryTrial(iTrial)
    if BpodSystem.Data.Custom.TrialData.ClickTask(iTrial)
        ...
        if BpodSystem.Data.Custom.TrialData.LaserTrial(iTrial) && TaskParameters.GUI.LaserStim==1
...
sma = AddState(sma, 'Name', 'rewarded_Lin_start',...
    ...
    'OutputActions', StopLaserWaveform); %[Wire1OutCorrect, {'BNCState',BNC2OutWT}]);
...
sma = AddState(sma, 'Name', 'unrewarded_Lin_start',...
    ...
    'OutputActions', StopLaserWaveform); %[Wire1OutError, {'BNCState',BNC2OutWT}]); 
sma = AddState(sma, 'Name', 'unrewarded_Rin_start',...
    'Timer', 0.05,...
    'StateChangeConditions', {RightPortOut,'unrewarded_Rin_grace','Tup','unrewarded_Rin'},...
    'OutputActions', StopLaserWaveform); %[Wire1OutError, {'BNCState',BNC2OutWT}]);

if BpodSystem.Data.Custom.TrialData.LaserTrial(iTrial) && TaskParameters.GUI.LaserTimeInvestment==1
    sma = AddState(sma, 'Name', 'rewarded_Lin',...
        ...
        'OutputActions', LaserStimulation); %'BNCState',BNC2OutWT});
