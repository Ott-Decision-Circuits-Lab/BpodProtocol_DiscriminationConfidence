...
sma = SetGlobalTimer(sma,3,FeedbackDelay/2);
...
if TaskParameters.GUI.HoldForError ==1
    
    sma = AddState(sma, 'Name', 'unrewarded_Rin',...
        'Timer', FeedbackDelay,...
        'StateChangeConditions', {RightPortOut,'unrewarded_Rin_grace','Tup','unrewarded_Rin_grace','GlobalTimer1_End','unrewarded_Rin_grace'},...
        'OutputActions', {strcat('PWM',num2str(LeftPort)),PortLEDs});

    sma = AddState(sma, 'Name', 'unrewarded_Rin_grace',...
        'Timer', TaskParameters.GUI.FeedbackDelayGrace,...
        'StateChangeConditions',{'Tup','SwitchTimerR2L',RightPortIn,'unrewarded_Rin','GlobalTimer1_End','SwitchTimerR2L',LeftPortIn, LeftSwitchAction},...
        'OutputActions', {strcat('PWM',num2str(LeftPort)),PortLEDs});

    sma = AddState(sma, 'Name', 'unrewarded_Lin',...
        'Timer', FeedbackDelay,...
        'StateChangeConditions', {LeftPortOut,'unrewarded_Lin_grace','Tup','unrewarded_Lin_grace','GlobalTimer1_End','unrewarded_Lin_grace'},...
        'OutputActions', {strcat('PWM',num2str(RightPort)),PortLEDs}); 

    sma = AddState(sma, 'Name', 'unrewarded_Lin_grace',...
        'Timer', TaskParameters.GUI.FeedbackDelayGrace,...
        'StateChangeConditions',{'Tup','SwitchTimerL2R',LeftPortIn,'unrewarded_Lin','GlobalTimer1_End','SwitchTimerL2R',RightPortIn, RightSwitchAction},...
        'OutputActions', {strcat('PWM',num2str(RightPort)),PortLEDs});
    
   sma = AddState(sma, 'Name', 'SwitchTimerR2L',... #SwtichTime includes FeedbackDelayGrace
        'Timer', TaskParameters.GUI.SwitchTimer,... 
        'StateChangeConditions',{LeftPortIn, LeftSwitchAction},...
    ...
    sma = AddState(sma, 'Name', 'SwitchTimerL2R',... #SwtichTime includes FeedbackDelayGrace
        'Timer', TaskParameters.GUI.SwitchTimer,... 
        'StateChangeConditions',{RightPortIn, RightSwitchAction},...
    ...
    'OutputActions', {'SoftCode',13,strcat('PWM',num2str(LeftPort)),PortLEDs, 'GlobalTimerTrig',3});
...
if TaskParameters.GUI.SwitchImmediateReward ==1
        ...
        'StateChangeConditions',{'Tup','water_L','GlobalTimer1_End','water_L','GlobalTimer3_End', 'water_L', LeftPortOut, 'LeftCorrectSwitchGrace'},...
        'OutputActions', {});
    
        sma = AddState(sma, 'Name', 'RightIncorrectSwitch',...
        'Timer', FeedbackDelay,...  %RightPokeAction --> Unre_Rin
        'StateChangeConditions',{'Tup','timeOut_IncorrectChoiceR','GlobalTimer1_End','timeOut_IncorrectChoiceR','GlobalTimer3_End','timeOut_IncorrectChoiceR',RightPortOut, 'RightIncorrectSwitchGrace'},...
        'OutputActions', {});

        sma = AddState(sma, 'Name', 'RightCorrectSwitch',...
            'Timer', FeedbackDelay,...  %RightPokeAction --> Unre_Rin
            'StateChangeConditions',{'Tup','water_R','GlobalTimer1_End','water_R','GlobalTimer3_End','water_R',RightPortOut, 'RightCorrectSwitchGrace'},...
            'OutputActions', {});

        sma = AddState(sma, 'Name', 'LeftIncorrectSwitch',...
        'Timer', FeedbackDelay,...  
        'StateChangeConditions',{'Tup','timeOut_IncorrectChoiceL','GlobalTimer1_End','timeOut_IncorrectChoiceL','GlobalTimer3_End','timeOut_IncorrectChoiceL',LeftPortOut, 'LeftIncorrectSwitchGrace'},...
        'OutputActions', {});
end
