...
LeftValveTimeBet  = GetValveTimes(TaskParameters.GUI.BetReward, LeftPort);
RightValveTimeBet  = GetValveTimes(TaskParameters.GUI.BetReward, RightPort);
...
sma = AddState(sma, 'Name', 'rewarded_Lin',...
    'Timer', FeedbackDelay,...
    'StateChangeConditions', {LeftPortOut,'rewarded_Lin_grace','Tup','skipped_feedback','GlobalTimer1_End','skipped_feedback'},...
    'OutputActions', {'BNCState',BNC2OutWT,strcat('PWM',num2str(LeftPort)),PortLEDs,strcat('PWM',num2str(RightPort)),PortLEDs});

sma = AddState(sma, 'Name', 'rewarded_Lin_grace',...
    'Timer', TaskParameters.GUI.FeedbackDelayGrace,...
    'StateChangeConditions',{'Tup','switchGraceL',LeftPortIn,'rewarded_Lin','GlobalTimer1_End','skipped_feedback',CenterPortIn,'skipped_feedback',RightPortIn, 'prewater_R'},...
    'OutputActions', {'BNCState',BNC2OutWT,strcat('PWM',num2str(LeftPort)),PortLEDs,strcat('PWM',num2str(RightPort)),PortLEDs});

sma = AddState(sma, 'Name', 'switchGraceL',...
    'Timer', TaskParameters.GUI.switchGrace,...
    'StateChangeConditions',{'Tup','skipped_feedback',LeftPortIn,'rewarded_Lin','GlobalTimer1_End','skipped_feedback',CenterPortIn,'skipped_feedback',RightPortIn, 'prewater_R'},...
    'OutputActions', {'BNCState',BNC2OutWT,strcat('PWM',num2str(LeftPort)),PortLEDs,strcat('PWM',num2str(RightPort)),PortLEDs});


sma = AddState(sma, 'Name', 'rewarded_Rin',...
    'Timer', FeedbackDelay,...
    'StateChangeConditions', {RightPortOut,'rewarded_Rin_grace','Tup','skipped_feedback','GlobalTimer1_End','skipped_feedback'},...
    'OutputActions', {'BNCState',BNC2OutWT,strcat('PWM',num2str(LeftPort)),PortLEDs,strcat('PWM',num2str(RightPort)),PortLEDs});

sma = AddState(sma, 'Name', 'rewarded_Rin_grace',...
    'Timer', TaskParameters.GUI.FeedbackDelayGrace,...
    'StateChangeConditions',{'Tup','switchGraceR',RightPortIn,'rewarded_Rin','GlobalTimer1_End','skipped_feedback',CenterPortIn,'skipped_feedback',LeftPortIn, 'prewater_L'},...
    'OutputActions', {'BNCState',BNC2OutWT,strcat('PWM',num2str(LeftPort)),PortLEDs,strcat('PWM',num2str(RightPort)),PortLEDs});

sma = AddState(sma, 'Name', 'switchGraceR',...
    'Timer', TaskParameters.GUI.switchGrace,...
    'StateChangeConditions',{'Tup','skipped_feedback',LeftPortIn,'prewater_L','GlobalTimer1_End','skipped_feedback',CenterPortIn,'skipped_feedback',RightPortIn, 'rewarded_Rin'},...
    'OutputActions', {'BNCState',BNC2OutWT,strcat('PWM',num2str(LeftPort)),PortLEDs,strcat('PWM',num2str(RightPort)),PortLEDs});


%incorrect left trial
sma = AddState(sma, 'Name', 'unrewarded_Lin_start',...
    'Timer', 0.05,...
    'StateChangeConditions', {LeftPortOut,'unrewarded_Lin_grace','Tup','unrewarded_Lin'},...
    'OutputActions', [Wire1OutError, {'BNCState',BNC2OutWT},strcat('PWM',num2str(LeftPort)),PortLEDs,strcat('PWM',num2str(RightPort)),PortLEDs]); 

sma = AddState(sma, 'Name', 'unrewarded_Lin',...
    'Timer', FeedbackDelay,...
    'StateChangeConditions', {LeftPortOut,'unrewarded_Lin_grace','Tup','IncorrectLeftBet','GlobalTimer1_End','IncorrectLeftBet'},...
    'OutputActions', {'BNCState',BNC2OutWT,strcat('PWM',num2str(LeftPort)),PortLEDs,strcat('PWM',num2str(RightPort)),PortLEDs}); 

sma = AddState(sma, 'Name', 'unrewarded_Lin_grace',...
    'Timer', TaskParameters.GUI.FeedbackDelayGrace,...
    'StateChangeConditions',{'Tup','UNREswitchGraceL',LeftPortIn,'unrewarded_Lin','GlobalTimer1_End','skipped_feedback',CenterPortIn,'skipped_feedback',RightPortIn, 'IncorrectRight'},...
    'OutputActions', {'BNCState',BNC2OutWT,strcat('PWM',num2str(LeftPort)),PortLEDs,strcat('PWM',num2str(RightPort)),PortLEDs});

sma = AddState(sma, 'Name', 'UNREswitchGraceL',...
    'Timer', TaskParameters.GUI.switchGrace,...
    'StateChangeConditions',{'Tup','skipped_feedback',RightPortIn,'IncorrectRight','GlobalTimer1_End','skipped_feedback',CenterPortIn,'skipped_feedback'},...
    'OutputActions', {'BNCState',BNC2OutWT,strcat('PWM',num2str(LeftPort)),PortLEDs,strcat('PWM',num2str(RightPort)),PortLEDs});

sma = AddState(sma, 'Name', 'IncorrectRight',...
    'Timer', FeedbackDelay,...
    'StateChangeConditions',{'Tup','timeOut_IncorrectChoiceR','GlobalTimer1_End','timeOut_IncorrectChoiceR',RightPortOut,'IncorrectRightGrace'},...
    'OutputActions', {});
sma = AddState(sma, 'Name', 'IncorrectRightGrace',...
    'Timer', TaskParameters.GUI.FeedbackDelayGrace,...
    'StateChangeConditions',{'Tup','skipped_feedback','GlobalTimer1_End','skipped_feedback',LeftPortIn,'skipped_feedback', RightPortIn, 'IncorrectRight', CenterPortIn,'skipped_feedback'},...
    'OutputActions', {});

sma = AddState(sma, 'Name', 'IncorrectLeftBet',...
    'Timer', 0.05,...
    'StateChangeConditions',{'Tup','LeftBetReward'},...
    'OutputActions', {'BNCState',BNC2OutWT});




%if incorrect right trial
sma = AddState(sma, 'Name', 'unrewarded_Rin',...
    'Timer', FeedbackDelay,...
    'StateChangeConditions', {RightPortOut,'unrewarded_Rin_grace','Tup','IncorrectRightBet','GlobalTimer1_End','IncorrectRightBet'},...
    'OutputActions', {'BNCState',BNC2OutWT,strcat('PWM',num2str(LeftPort)),PortLEDs,strcat('PWM',num2str(RightPort)),PortLEDs});

sma = AddState(sma, 'Name', 'unrewarded_Rin_grace',...
    'Timer', TaskParameters.GUI.FeedbackDelayGrace,...
    'StateChangeConditions',{'Tup','UNREswitchGraceR',RightPortIn,'unrewarded_Rin','GlobalTimer1_End','skipped_feedback',CenterPortIn,'skipped_feedback',LeftPortIn, 'IncorrectLeft'},...
    'OutputActions', {'BNCState',BNC2OutWT,strcat('PWM',num2str(LeftPort)),PortLEDs,strcat('PWM',num2str(RightPort)),PortLEDs});

sma = AddState(sma, 'Name', 'UNREswitchGraceR',...
    'Timer', TaskParameters.GUI.switchGrace,...
    'StateChangeConditions',{'Tup','skipped_feedback',LeftPortIn,'IncorrectLeft','GlobalTimer1_End','skipped_feedback',CenterPortIn,'skipped_feedback'},...
    'OutputActions', {'BNCState',BNC2OutWT,strcat('PWM',num2str(LeftPort)),PortLEDs,strcat('PWM',num2str(RightPort)),PortLEDs});

sma = AddState(sma, 'Name', 'IncorrectLeft',...
    'Timer', FeedbackDelay,...
    'StateChangeConditions',{'Tup','timeOut_IncorrectChoiceL','GlobalTimer1_End','timeOut_IncorrectChoiceL',LeftPortOut,'IncorrectLeftGrace'},...
    'OutputActions', {});

sma = AddState(sma, 'Name', 'IncorrectLeftGrace',...
    'Timer', TaskParameters.GUI.FeedbackDelayGrace,...
    'StateChangeConditions',{'Tup','skipped_feedback','GlobalTimer1_End','skipped_feedback',LeftPokeIn,'IncorrectLeft', RightPortIn, 'skipped_feedback', CenterPokeIn,'skipped_feedback'},...
    'OutputActions', {});

sma = AddState(sma, 'Name', 'IncorrectRightBet',...
    'Timer', 0.05,...
    'StateChangeConditions',{'Tup','RightBetReward'},...
    'OutputActions', {'BNCState',BNC2OutWT});




%reward & drinking states
sma = AddState(sma, 'Name', 'prewater_L',...
    'Timer', FeedbackDelay,...
    'StateChangeConditions', {'Tup','water_L','GlobalTimer1_End','water_L',LeftPortOut,'skipped_feedback'},...
    'OutputActions', {});

sma = AddState(sma, 'Name', 'prewater_LGrace',...
    'Timer', TaskParameters.GUI.FeedbackDelayGrace,...
    'StateChangeConditions', {'Tup','skipped_feedback','GlobalTimer1_End','skipped_feedback',LeftPortIn,'prewater_L'},...
    'OutputActions', {});

sma = AddState(sma, 'Name', 'prewater_R',...
    'Timer', FeedbackDelay,...
    'StateChangeConditions', {'Tup','water_R','GlobalTimer1_End','water_R',RightPortOut,'skipped_feedback'},...
    'OutputActions', {'ValveState', RightValve,'BNCState',BNC2OutReward});

sma = AddState(sma, 'Name', 'prewater_RGrace',...
    'Timer', TaskParameters.GUI.FeedbackDelayGrace,...
    'StateChangeConditions', {'Tup','skipped_feedback','GlobalTimer1_End','skipped_feedback',RightPortIn,'prewater_R'},...
    'OutputActions', {'ValveState', RightValve,'BNCState',BNC2OutReward});
...
sma = AddState(sma, 'Name', 'LeftBetReward',...
    'Timer', LeftValveTimeBet,...
    'StateChangeConditions', {'Tup','DrinkingL'},...
    'OutputActions', {'ValveState', LeftValve,'BNCState',BNC2OutReward});

sma = AddState(sma, 'Name', 'RightBetReward',...
    'Timer', RightValveTimeBet,...
    'StateChangeConditions', {'Tup','DrinkingR'},...
    'OutputActions', {'ValveState', RightValve,'BNCState',BNC2OutReward});
