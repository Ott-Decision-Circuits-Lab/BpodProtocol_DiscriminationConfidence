...
sma = AddState(sma, 'Name', 'stay_Cin',...
    ...
    'StateChangeConditions', {'Port2Out','broke_fixation','Tup', 'stimulus_delivery'},...
    'OutputActions',{});
