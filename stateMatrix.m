...
sma = NewStateMatrix();
sma = SetGlobalTimer(sma,1,BpodSystem.Data.Custom.FeedbackDelay(end));
...
sma = AddState(sma, 'Name', 'wait_Sin',...
    ...
    'OutputActions',{'SoftCode',2,'PWM1',255,'PWM3',255,'GlobalTimerTrig',1});
...
sma = AddState(sma, 'Name', 'rewarded_Lin_grace',...
    'Timer', BpodSystem.Data.Custom.FeedbackDelayGrace(end),...
    'StateChangeConditions',{'Tup','skipped_feedback','Port1In','rewarded_Lin','GlobalTimer1_End','rewarded_Lin','Port2In','skipped_feedback','Port3In','skipped_feedback'},...
    'OutputActions', {});
...
sma = AddState(sma, 'Name', 'rewarded_Rin_grace',...
    'Timer', BpodSystem.Data.Custom.FeedbackDelayGrace(end),...
    'StateChangeConditions',{'Tup','skipped_feedback','Port3In','rewarded_Rin','GlobalTimer1_End','rewarded_Rin','Port2In','skipped_feedback','Port1In','skipped_feedback'},...
    'OutputActions', {});
...
sma = AddState(sma, 'Name', 'unrewarded_Lin_grace',...
    'Timer', BpodSystem.Data.Custom.FeedbackDelayGrace(end),...
    'StateChangeConditions',{'Tup','skipped_feedback','Port1In','unrewarded_Lin','GlobalTimer1_End','unrewarded_Lin','Port2In','skipped_feedback','Port3In','skipped_feedback'},...
    'OutputActions', {});
...
sma = AddState(sma, 'Name', 'unrewarded_Rin_grace',...
    'Timer', BpodSystem.Data.Custom.FeedbackDelayGrace(end),...
    'StateChangeConditions',{'Tup','skipped_feedback','Port3In','unrewarded_Rin','GlobalTimer1_End','unrewarded_Rin','Port2In','skipped_feedback','Port1In','skipped_feedback'},...
    'OutputActions', {});
