...
sma = AddState(sma, 'Name', 'wait_Cin',...
    ...
    'OutputActions', {'SoftCode',1,strcat('PWM',num2str(CenterPort)),255,'BNCState',BNC2OutWaitC});
...
if BpodSystem.Data.Custom.AuditoryTrial(iTrial)
    if BpodSystem.Data.Custom.ClickTask(iTrial)
        ...
        sma = AddState(sma, 'Name', 'wait_Sin',...
            ...
            'OutputActions',{'BNCState',0+BNC2OutMT,strcat('PWM',num2str(LeftPort)),255,strcat('PWM',num2str(RightPort)),255});
    else %frequency task 
        sma = AddState(sma, 'Name', 'stay_Cin',...
            'Timer', TaskParameters.GUI.StimDelay,...
        ...
        sma = AddState(sma, 'Name', 'wait_Sin',...
            'Timer',TaskParameters.GUI.ChoiceDeadLine,...
            'StateChangeConditions', {LeftPortIn,'start_Lin',RightPortIn,'start_Rin','Tup','missed_choice'},...
            'OutputActions',{'BNCState',BNC2OutMT,'SoftCode',22,strcat('PWM',num2str(LeftPort)),255,strcat('PWM',num2str(RightPort)),255});
    end
else
    sma = AddState(sma, 'Name', 'stay_Cin',...
        'Timer', TaskParameters.GUI.StimDelay,...
    ...
    sma = AddState(sma, 'Name', 'wait_Sin',...
        'Timer',TaskParameters.GUI.ChoiceDeadLine,...
        'StateChangeConditions', {LeftPortIn,'start_Lin',RightPortIn,'start_Rin','Tup','missed_choice'},...
        'OutputActions',{'BNCState',BNC2OutMT,'SoftCode',1,strcat('PWM',num2str(LeftPort)),255,strcat('PWM',num2str(RightPort)),255});
end
...
elseif  TaskParameters.GUI.IncorrectChoiceFeedbackType == 3 % IncorrectChoiceFeedbackType == PortLED
    sma = AddState(sma, 'Name', 'timeOut_IncorrectChoice',...
        ...
        'OutputActions',{strcat('PWM',num2str(LeftPort)),255,strcat('PWM',num2str(CenterPort)),255,strcat('PWM',num2str(RightPort)),255,'BNCState',BNC2OutFB});
