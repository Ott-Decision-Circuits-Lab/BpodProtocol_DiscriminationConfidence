...
if LeftRewarded == 1
    ...
    LeftSwitchAction = 'CorrectLeftSwitch';
    RightSwitchAction = 'IncorrectRightSwitch';
    
elseif LeftRewarded == 0
    LeftPokeAction = 'unrewarded_Lin';
    RightPokeAction = 'rewarded_Rin';
    LeftSwitchAction = 'IncorrectLeftSwitch';
    RightSwitchAction = 'CorrectRightSwitch';
else
...
sma = AddState(sma, 'Name', 'SwitchTimerL2R',... #SwtichTime includes FeedbackDelayGrace
    ...
    'OutputActions', {strcat('PWM',num2str(RightPort)),PortLEDs, 'SoftCode',11});
...
sma = AddState(sma, 'Name', 'SwitchTimerR2L',... #SwtichTime includes FeedbackDelayGrace
    ...
    'OutputActions', {strcat('PWM',num2str(LeftPort)),PortLEDs, 'SoftCode',11});
...
sma = AddState(sma, 'Name', 'LeftCorrectSwitchGrace',...
    'Timer', TaskParameters.GUI.FeedbackDelayGrace,...  %RightPokeAction --> Unre_Rin
    'StateChangeConditions',{'Tup','SkippedFeedback','GlobalTimer1_End','SkippedFeedback',LeftPortIn, 'LeftCorrectSwitch'},...
    'OutputActions', {});
...
sma = AddState(sma, 'Name', 'RightCorrectSwitchGrace',...
    'Timer', TaskParameters.GUI.FeedbackDelayGrace,...  %RightPokeAction --> Unre_Rin
    'StateChangeConditions',{'Tup','SkippedFeedback','GlobalTimer1_End','SkippedFeedback',RightPortIn, 'RightCorrectSwitch'},...
    'OutputActions', {});
