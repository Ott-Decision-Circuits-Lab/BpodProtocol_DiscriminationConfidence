...
sma = AddState(sma, 'Name', 'unrewarded_Lin_grace',...
    'Timer', TaskParameters.GUI.FeedbackDelayGrace,...
    'StateChangeConditions',{'Tup','UNREswitchGraceL',LeftPortIn,'unrewarded_Lin','GlobalTimer1_End','skipped_feedback',CenterPortIn,'skipped_feedback',RightPortIn, 'unrewarded_RinFINAL'},...
    'OutputActions', {'BNCState',BNC2OutWT,strcat('PWM',num2str(LeftPort)),PortLEDs,strcat('PWM',num2str(RightPort)),PortLEDs});
...
sma = AddState(sma, 'Name', 'IncorrectRight',...
    'Timer', FeedbackDelay,...
    'StateChangeConditions',{'Tup','timeOut_IncorrectChoiceR','GlobalTimer1_End','timeOut_IncorrectChoiceR',RightPokeOut,'IncorrectRightGrace'},...
    'OutputActions', {});
sma = AddState(sma, 'Name', 'IncorrectRightGrace',...
    'Timer', TaskParameters.GUI.FeedbackDelayGrace,...
    'StateChangeConditions',{'Tup','skipped_feedback','GlobalTimer1_End','skipped_feedback',LeftPokeIn,'skipped_feedback', RightPokeIn, 'IncorrectRight', CenterPokeIn,'skipped_feedback'},...
    'OutputActions', {});
...
sma = AddState(sma, 'Name', 'unrewarded_Rin_grace',...
    'Timer', TaskParameters.GUI.FeedbackDelayGrace,...
    'StateChangeConditions',{'Tup','UNREswitchGraceR',RightPortIn,'unrewarded_Rin','GlobalTimer1_End','skipped_feedback',CenterPortIn,'skipped_feedback',LeftPortIn, LeftPokeAction},...
    'OutputActions', {'BNCState',BNC2OutWT,strcat('PWM',num2str(LeftPort)),PortLEDs,strcat('PWM',num2str(RightPort)),PortLEDs});
...
sma = AddState(sma, 'Name', 'IncorrectLeft',...
    'Timer', FeedbackDelay,...
    'StateChangeConditions',{'Tup','timeOut_IncorrectChoiceL','GlobalTimer1_End','timeOut_IncorrectChoiceL',LeftPokeOut,'IncorrectLeftGrace'},...
    'OutputActions', {});

sma = AddState(sma, 'Name', 'IncorrectLeftGrace',...
    'Timer', TaskParameters.GUI.FeedbackDelayGrace,...
    'StateChangeConditions',{'Tup','skipped_feedback','GlobalTimer1_End','skipped_feedback',LeftPokeIn,'IncorrectLeft', RightPokeIn, 'skipped_feedback', CenterPokeIn,'skipped_feedback'},...
    'OutputActions', {});
...
sma = AddState(sma, 'Name', 'prewater_L',...
    'Timer', FeedbackDelay,...
    'StateChangeConditions', {'Tup','water_L','GlobalTimer1_End','water_L',LeftPokeOut,'skipped_feedback'},...
    'OutputActions', {});

sma = AddState(sma, 'Name', 'prewater_R',...
    'Timer', FeedbackDelay,...
    'StateChangeConditions', {'Tup','water_R','GlobalTimer1_End','water_R',RightPokeOut,'skipped_feedback'},...
