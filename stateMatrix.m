...
sma = AddState(sma, 'Name', 'unrewarded_Lin',...
    'Timer', BpodSystem.Data.Custom.FeedbackDelay(end),...
    'StateChangeConditions', {'Port1Out','skipped_feedback','Tup','timeOut_IncorrectChoice'},...
    'OutputActions', {}); % SHOULD WRITE WAVEFORM TO PULSEPAL WITHIN THIS CODE
sma = AddState(sma, 'Name', 'unrewarded_Rin',...
    'Timer', BpodSystem.Data.Custom.FeedbackDelay(end),...
    'StateChangeConditions', {'Port3Out','skipped_feedback','Tup','timeOut_IncorrectChoice'},...
