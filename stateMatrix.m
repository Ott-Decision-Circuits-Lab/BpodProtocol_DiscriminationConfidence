...
sma = AddState(sma, 'Name', 'wait_Cin',...
    ...
    'OutputActions', {'SoftCode',1,strcat('PWM',num2str(CenterPort)),255});
...
sma = AddState(sma, 'Name', 'timeOut_EarlyWithdrawal',...
    ...
    'StateChangeConditions',{'Tup','ITI'},...
    'OutputActions',{'SoftCode',11});
if  TaskParameters.GUI.NegativeFeedbackType == 3 % NegativeFeedbackType == PortLED
    ...
    sma = AddState(sma, 'Name', 'timeOut_IncorrectChoice2',...
        'Timer',TaskParameters.GUI.TimeOutIncorrectChoice - 0.5,...
        'StateChangeConditions',{'Tup','ITI'},...
        'OutputActions',{});
else % NegativeFeedbackType == None ou Tone
    sma = AddState(sma, 'Name', 'timeOut_IncorrectChoice',...
...
if  TaskParameters.GUI.NegativeFeedbackType == 3 % NegativeFeedbackType == PortLED
    ...
    sma = AddState(sma, 'Name', 'timeOut_SkippedFeedback2',...
        'Timer',TaskParameters.GUI.TimeOutSkippedFeedback - 0.5,...
        'StateChangeConditions',{'Tup','ITI'},...
        'OutputActions',{});
else
    sma = AddState(sma, 'Name', 'timeOut_SkippedFeedback',...
