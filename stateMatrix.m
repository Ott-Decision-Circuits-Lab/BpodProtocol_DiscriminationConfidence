...
sma = AddState(sma, 'Name', 'rewarded_Rin_grace',...
    'Timer', BpodSystem.Data.Custom.FeedbackDelayGrace(end),...
    'StateChangeConditions',{'Tup','skipped_feedback','Port3In','rewarded_Rin','GlobalTimer1_End','skipped_feedback','Port2In','timeOut_IncorrectChoice','Port1In','timeOut_IncorrectChoice'},...
    'OutputActions', {});
...
sma = AddState(sma, 'Name', 'unrewarded_Lin_grace',...
    'Timer', BpodSystem.Data.Custom.FeedbackDelayGrace(end),...
    'StateChangeConditions',{'Tup','skipped_feedback','Port1In','unrewarded_Lin','GlobalTimer1_End','timeOut_IncorrectChoice','Port2In','timeOut_IncorrectChoice','Port3In','timeOut_IncorrectChoice'},...
    'OutputActions', {});
...
sma = AddState(sma, 'Name', 'unrewarded_Rin_grace',...
    'Timer', BpodSystem.Data.Custom.FeedbackDelayGrace(end),...
    'StateChangeConditions',{'Tup','skipped_feedback','Port3In','unrewarded_Rin','GlobalTimer1_End','timeOut_IncorrectChoice','Port2In','skipped_feedback','Port1In','skipped_feedback'},...
    'OutputActions', {});
